...
const trex = {
  ...
  // Complete the following requests WITHOUT using any array methods 
  ...
  // animal name in front of the habitats. Return an array with only
  // the animal and scientific names in it.  The individual values in the 
  ...
  // name to convert them all to lower case.  
  // Log the resut.

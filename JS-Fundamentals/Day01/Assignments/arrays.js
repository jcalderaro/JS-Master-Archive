...
console.log('Look here', carYears);
...
console.log('Look Twice', oldCars.length); 
...
// Four Advanced Methods To Memorized Are: Filter, Reduce, Map
// For Each : Impacts the original array. The Other 3 do not.
